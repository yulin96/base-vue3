...
const resultUrl = ref('https://oss.eventnet.cn/mm/temp/4476878e-d585-4040-95d0-08366c80608e_0.png')
    ...
    <section class="scroll-box index min-h-screen overflow-y-auto bg-transparent">
      <main class="page-shell mx-auto flex min-h-screen w-full flex-col px-32 pt-54">
        ...
        <section v-if="resultUrl" class="mt-40 pb-20">
          ...
          >
            <!--  -->
            <img class="absolute bottom-30 z-20 w-550" src="https://oss.eventnet.cn/mm/temp/bn2.png" />
            <img
              :src="resultUrl"
              class="rounded-22 relative z-30 w-400 object-contain mix-blend-multiply"
              alt="AI 生成结果"
            />
          </div>
